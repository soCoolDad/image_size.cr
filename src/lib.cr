...
lib LibStbi
  ...
  fun stbir_resize_uint8_linear(buffer : LibC::UChar*, width : LibC::Int, height : LibC::Int, stride : LibC::Int, output : LibC::UChar*, output_width : LibC::Int, output_height : LibC::Int, output_stride : LibC::Int, channels : LibC::Int) : LibC::Int
